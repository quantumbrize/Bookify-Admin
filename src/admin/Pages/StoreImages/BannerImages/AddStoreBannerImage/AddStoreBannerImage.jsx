...
import './AddStoreBannerImage.css';
    ...
    const addBanner = async (e) => {
        ...
        if (images.length === 0) {
            ...
            try {
                ...
                const response = await fetch(`${config.backEndBaseUrl}api/store/banner/add/${uid}`, {
                    method: 'POST',
                    headers: {
                ...
                if (result.status) {
                    ...
                    navigate(`/admin/store/images/${uid}?tab=1`);
                    resetForm();
                } else {
...
export default AddStoreBannerImage