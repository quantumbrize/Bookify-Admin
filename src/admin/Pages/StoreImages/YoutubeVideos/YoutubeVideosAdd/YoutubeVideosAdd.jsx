    ...
    const addBanner = async (e) => {
        ...
        if (images.length === 0) {
            ...
            try {
                ...
                const response = await fetch(`${config.backEndBaseUrl}api/store/video/add/${uid}`, {
                    method: 'POST',
                    headers: {
                ...
                if (result.status) {
                    ...
                    navigate(`/admin/store/images/${uid}?tab=4`);
                    resetForm();
                } else {
                                    ...
                                    <div className="main-content-inner">
                                        <div className="wg-box wg-box-container">
                                            <form className="form-new-product form-style-1" onSubmit={addBanner}>
                                                <fieldset>
                                                    <div className="body-title">Youtube Links<span className="tf-color-1">*</span></div>
                                                                                    ...
                                                                                    <div className="image-item__btn-wrapper">
                                                                                        ...
                                                                                        <div>
                                                                                            ...
                                                                                            <input
                                                                                                className='banner-img-input'
                                                                                                type="text"
                                                                                                placeholder={`Video ${index + 1} Link`}
...
export default YoutubeVideosAdd